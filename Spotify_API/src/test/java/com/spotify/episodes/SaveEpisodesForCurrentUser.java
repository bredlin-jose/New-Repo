...
public class SaveEpisodesForCurrentUser extends RestAssuredBaseTest{
	@DataProviderFileRowFilter(file = "/src/test/resources/TestData/Data.xlsx",sql = "Select * from Sheet2 where testCase ='TC16'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Save Episodes for Current User")
	public void saveRpisodesForCurrentUser(String testCase, String endpoints, String queryParamKey, String queryParamValue, String pathParamKey, String pathParamValue) {
